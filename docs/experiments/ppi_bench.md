...
|DATABASE_PATH|Path to the LMDB database with corresponding protein embeddings. This solely determines which pLM the PPI model is based on.|Various, all from the [embeddings folder](/data#embeddings).|
