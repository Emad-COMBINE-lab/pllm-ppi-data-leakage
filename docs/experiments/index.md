...
| Section         | Description                     |
|-----------------|---------------------------------|
|[**`encode_llm`**](encode_llm.md)|Common API for encoding amino acid sequences with various pLMs.|
|[**`embedding_dbs`**](embedding_dbs.md)|Scripts for generating databases of amino acid embeddings.|
|[**`speed_bench`**](speed_bench.md)|Scripts for benchmarking the speed of the various pLMs.|
|[**`ppi_bench`**](ppi_bench.md)|Scripts for training pLM-based PPI inference models.|
